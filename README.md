...
## Projects
### [Mental Health Project](https://github.com/williamnzoiwu/Project-4)
A chatbot that uses machine learning to offer help or advice to users who may be struggling with their mental health. Displays health statistics in the US from 2011-2021 and uses scikit learn and tensorflow to create a model that could interpret user input and offer various responses. 

## Education
**Texas A&M University, College Station** - B.A., Telecommunication Media Studies\
**University of Texas at Austin** - Certificate, Data Analysis & Visualization
